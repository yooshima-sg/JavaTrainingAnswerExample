...
@Component
@Qualifier("allSQLResolver")
public class AllSQLResolver implements IResolver {
    private final Logger logger = LoggerFactory.getLogger(AllSQLResolver.class);
    private final JdbcTemplate jdbcTemplate;

    public AllSQLResolver(JdbcTemplate jdbcTemplate) {
